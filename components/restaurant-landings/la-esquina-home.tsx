...
const testimonials = [
  {
    name: "Lucas Pérez",
    comment:
      "Increíble que puedas comer tan bien y tan rápido. El choripán es de los mejores que probé. Perfecto para el almuerzo.",
    rating: 5,
  },
  {
    name: "Sofía Herrera",
    comment:
      "Vengo siempre que quiero algo rico sin esperar una hora. La calidad es la misma que Picado Fino pero más accesible.",
    rating: 5,
  },
  {
...
type LaEsquinaHomeProps = {
  basePath: string
  otherRestaurantPath: string
}

export function LaEsquinaHome({ basePath, otherRestaurantPath }: LaEsquinaHomeProps) {
  return (
    <div className="min-h-screen">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/gallery-1.jpg" alt="La Esquina de Picado" fill className="object-cover" priority />
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
              <Image src="/images/gallery-5.jpg" alt="Cocina de La Esquina" fill className="object-cover" />
            </div>
            <div className="space-y-6">
              <span className="text-primary text-sm font-semibold uppercase tracking-wider">Nuestra Propuesta</span>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-primary text-sm font-semibold uppercase tracking-wider">Nuestros Favoritos</span>
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mt-4">Rápido y delicioso</h2>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mt-4">El sabor en imágenes</h2>
            </div>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mt-4">Lo que dicen de nosotros</h2>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            <div>
              ...
              <p className="text-xl font-semibold text-foreground">Visitá Picado Fino</p>
            </div>
            <Button asChild variant="outline" className="border-border text-foreground hover:bg-secondary">
      ...
      <section className="py-24 bg-primary">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-primary-foreground mb-6">Hacé tu pedido</h2>
